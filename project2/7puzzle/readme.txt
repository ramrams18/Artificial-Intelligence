->In the file 7puzzle_facts1.txt and 7puzzle_facts2.txt, the tiles and the locations
  are defined. The initial state are defined in the preconds,along with the additional 
  instances that verify that the correct tile is passed and the location passed is also 
  valid. The tileAt instance tells that which tile is at the specified location.
